...
{    
    ...
    static const CCheckpointData data = {
        &mapCheckpoints,
        1460465016, // * UNIX timestamp of last checkpoint block (Genesis: 1388281113)
        251,     // * total number of transactions between genesis and last checkpoint (Genesis: 156464)
