...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Espers: links)
...
{
    // clicking on Espers: URLs creates FileOpen events on the Mac:
