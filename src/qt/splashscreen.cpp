    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText3  = QChar(0xA9)+QString(" 2016 ") + QString(tr("The Espers developers"));
    ...
    pixPaint.drawText(newPixmap.width()-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpace+12,copyrightText3);
